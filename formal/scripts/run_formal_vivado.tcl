...
puts $tb_fd "        .clk   (clk),"
puts $tb_fd "        .rst_n (rst_n)"
puts $tb_fd "    );"
puts $tb_fd ""
puts $tb_fd "    // Run for 10000 cycles then finish"
puts $tb_fd "    initial begin"
puts $tb_fd "        repeat (10000) @(posedge clk);"
...
exec xelab tb_formal_wrapper -s $snapshot -timescale 1ns/1ps -sv_lib dpi 2>@1
